...
export class ValidationComponent implements OnInit {
  ...
  radioValidationForm: UntypedFormGroup;
  ...
  ngOnInit() {
    ...
    this.radiosubmit = false;


        /**
     * Radio validation form
     */
         this.radioValidationForm = this.formBuilder.group({
          ap_account: ['', Validators.required]
        });
        this.submit = false;
        this.formsubmit = false;
        this.typesubmit = false;
